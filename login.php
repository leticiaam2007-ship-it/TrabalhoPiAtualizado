...
<head>
  ...
  <style>
    .auth-page { display:flex;min-height:100vh;align-items:center;justify-content:center;padding:80px 16px; }
    .auth-card { background:var(--card);padding:28px;border-radius:12px;max-width:420px;width:100%;box-shadow:0 12px 30px rgba(0,0,0,0.4); }
    .auth-card h2{ margin-bottom:12px; color:var(--highlight); }
    ...
    .note { font-size:0.9rem;color:rgba(0,0,0,0.6); margin-top:8px; }
    .small-note { font-size:0.85rem;color:rgba(0,0,0,0.55); margin-top:6px; }
  </style>
</head>
<body>
...
$mensagem = "Cadastro realizado";
  ...
  <main class="auth-page">
    <div class="auth-card">
      <div><?php if ($mensagem != null){ echo $mensagem; } ?></div>
      <div class="tabs-auth">
